## First version of CIDer
## Read in a HCD dlib, return a CIDer'd dlib

import numpy as np, pandas as pd
import sqlite3
import pickle, sys, zlib, struct, re, itertools
from scipy import interpolate


## Bring in model components
charge_pairs = [(2,1), (2,2), (3,1), (3,2)]
y_mz_spline_data = pickle.load(open('y_mz_spline_data_201110.pkl','rb'))

y_mz_spline_by_cp = dict( [(charge_pairs[i], 
                            interpolate.interp1d(*y_mz_spline_data[0],y_mz_spline_data[i+1])) 
                           for i in range(4)] )
y_pn_dict = pickle.load(open('y_pn_dict_201110.pkl','rb'))
y_Rcount_by_yn_dict = pickle.load(open('y_Rcount_by_yn_dict_201111.pkl','rb'))
y_Kcount_by_yn_dict = pickle.load(open('y_Kcount_by_yn_dict_201111.pkl','rb'))
y_Hcount_by_yn_dict = pickle.load(open('y_Hcount_by_yn_dict_201111.pkl','rb'))
y_bRcount_by_yn_dict = pickle.load(open('y_bRcount_by_yn_dict_201111.pkl','rb'))
y_bKcount_by_yn_dict = pickle.load(open('y_bKcount_by_yn_dict_201111.pkl','rb'))
y_bHcount_by_yn_dict = pickle.load(open('y_bHcount_by_yn_dict_201111.pkl','rb'))
y_side_weights = pickle.load(open('y_side_weights_dict_201111.pkl','rb'))
b_mz_spline_data = pickle.load(open('b_mz_spline_data_201116.pkl','rb'))
b_mz_spline_by_cp = dict( [(charge_pairs[i], 
                             interpolate.interp1d(*b_mz_spline_data[0],b_mz_spline_data[i+1])) 
                            for i in range(4)] )
b_pn_dict = pickle.load(open('b_pn_dict_201116.pkl','rb'))
b_Rcount_by_bn_dict = pickle.load(open('b_Rcount_by_bn_dict_201116.pkl','rb'))
b_Kcount_by_bn_dict = pickle.load(open('b_Kcount_by_bn_dict_201116.pkl','rb'))
b_Hcount_by_bn_dict = pickle.load(open('b_Hcount_by_bn_dict_201116.pkl','rb'))
b_yRcount_by_bn_dict = pickle.load(open('b_yRcount_by_bn_dict_201116.pkl','rb'))
b_yKcount_by_bn_dict = pickle.load(open('b_yKcount_by_bn_dict_201116.pkl','rb'))
b_yHcount_by_bn_dict = pickle.load(open('b_yHcount_by_bn_dict_201116.pkl','rb'))
b_side_weights = pickle.load(open('b_side_weights_dict_201129.pkl','rb'))
